...
const GlobalKioskStyles = ({ dark, theme }: { dark: boolean, theme: any }) => (
  <style>{`
    ...
    .kiosk-detail-card {
       width: 90%; max-width: 860px; flex: 1 1 auto; min-height: 800px; max-height: 85vh; background: ${dark ? 'rgba(18, 87, 172, 0.15)' : 'rgba(255,255,255,0.85)'};
     ...
     return (
       <>
         ...
         <div className="screensaver-fullscreen" style={{ background: '#000' }}>
            <img key={currentSlide} src={presentationSlides[currentSlide].img} className="slide-enter" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.4, position: 'absolute' }} />
